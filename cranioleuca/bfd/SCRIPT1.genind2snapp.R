...
#create nexus file to create base xml file in Beauti following instructions in Step 6.2
#		http://evomicsorg.wpengine.netdna-cdn.com/wp-content/uploads/2016/01/BFDstar-tutorial1.pdf
#create a template xml using all individuals without assigning individuals to populations 
#Under Model Parameters, check the following
#	Keep 'Mutation Rate U', 'Mutation Rate V', and 'Coalescence Rate' at defaults
#	Uncheck 'Include Polymorphic Site'
#	Make sure "Use Log Likelihood Correction" is checked!
#Do not touch any setting under Prior and MCMC

gl2snapp(g, outfile = file.name, outpath = paste0('runs/',dataset), v = 2)
